...
//    open fun functionTypeFunc(arg: () -> Child): (Child) -> Parent { TODO("") }
...
//    open fun subtypeFunctionTypeFunc(arg: () -> Child): (Child) -> Parent = { _ -> TODO() }
...
//    override fun functionTypeFunc(arg: () -> Child): (Child) -> Parent = { _ -> TODO() }
...
//    override fun subtypeFunctionTypeFunc(arg: () -> Child): (Parent) -> Child = { _ -> TODO() }
