...
open class LowLevelFirAnalyzerFacade(
    ...
    override val result: FirResult
        get() {
            val output = ModuleCompilerAnalyzedOutput(llResolutionFacade.useSiteFirSession, scopeSession, allFirFiles.values.toList())
    ...
    fun runCheckers(): Map<FirFile, List<KtDiagnostic>> {
        ...
        return allFirFiles.values.associateWith { firFile ->
            ...
            val diagnostics = ktFile.collectDiagnosticsForFile(llResolutionFacade, diagnosticCheckerFilter)
