...
context(a: A) fun A.usage10() { <!AMBIGUOUS_CONTEXT_ARGUMENT("A")!>contextOf<!><A>() }
context(a: A) fun A.usage11(): A = <!AMBIGUOUS_CONTEXT_ARGUMENT("A")!>contextOf<!><A>()
context(a: A, b: B) fun usage12() { <!AMBIGUOUS_CONTEXT_ARGUMENT("A")!>contextOf<!><A>() }
