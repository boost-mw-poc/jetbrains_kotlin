...
public inline fun inlineFun(obj: Any) {
    PrivateObject.<!NON_PUBLIC_CALL_FROM_PUBLIC_INLINE!>toString<!>()
    PrivateObject.<!NON_PUBLIC_CALL_FROM_PUBLIC_INLINE!>foo<!>()
    PrivateClass::class
}

internal inline fun internalInlineFun(obj: Any) {
    PrivateObject.<!PRIVATE_CLASS_MEMBER_FROM_INLINE!>toString<!>()
...
public class PublicClass : Parent() {
    public inline fun inlineFun() {
        ProtectedObject.<!PROTECTED_CALL_FROM_PUBLIC_INLINE_ERROR!>toString<!>()
