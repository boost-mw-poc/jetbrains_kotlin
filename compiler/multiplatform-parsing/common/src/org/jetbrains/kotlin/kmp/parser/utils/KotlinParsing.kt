...
internal class KotlinParsing private constructor(builder: SemanticWhitespaceAwareSyntaxBuilder, isTopLevel: Boolean, isLazy: Boolean) :
    ...
    companion object {
        ...
        private val ANNOTATION_TARGET_ERROR_MESSAGES: Map<SyntaxElementType, String> = (ANNOTATION_TARGETS + KtTokens.FILE_KEYWORD)
            .associateWith { """Expecting "$it${KtTokens.COLON}" prefix for $it annotations""" }
