...
object KtTokens : SyntaxElementTypesWithIds() {
    ...
    val VISIBILITY_MODIFIERS: SyntaxElementTypeSet = syntaxElementTypeSetOf(PRIVATE_MODIFIER, PUBLIC_MODIFIER, INTERNAL_MODIFIER, PROTECTED_MODIFIER)
    val MODALITY_MODIFIERS: SyntaxElementTypeSet = syntaxElementTypeSetOf(ABSTRACT_MODIFIER, FINAL_MODIFIER, SEALED_MODIFIER, OPEN_MODIFIER)
